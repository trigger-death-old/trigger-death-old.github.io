...
modscript_path: /mods/triggerverse/Triggerverse.js
modscript_id: Triggerverse
---
/*=====================================================================================
TRIGGERVERSE MOD
=======================================================================================*/
...
Triggerverse.List = function (state) {
	...
	else if (this.name == "cookieverse") addStyle = "background-image:url('" + GetModURL() + "img/cookieverse.png');";
	else if (this.name == "grandmaverse") addStyle = "background-image:url('" + GetModURL() + "img/grandmaverse.png');";
