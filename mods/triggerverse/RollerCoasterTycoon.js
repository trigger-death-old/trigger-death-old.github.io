---
layout: modscript-redirect
modscript_path: /mods/triggerverse/RollerCoasterTycoon.js
modscript_id: RollerCoasterTycoon
---
/*=====================================================================================
...
// Raw File:     https://raw.githubusercontent.com/trigger-segfault/trigger-segfault.github.io/master/mods/triggerverse/RollerCoasterTycoon.js
...
function LoadMod(name, path) {
	...
	if (!IsModLoaded(name)) {
		...
		js.setAttribute('src', GetModURL() + path + '.js');
		document.head.appendChild(js);
		console.log('Loaded the mod ' + GetModURL() + path + '.js' + ', ' + name + '.');
	}
}
...
RollerCoasterTycoon.ListRules = function () {
	...
	if (this.type.name == "mood") {
		...
		'<div style="background-image: url(\'' + GetModURL() + 'img/' + RollerCoasterTycoon.GuestMoodIcons[this.name] + '.png\'); width: 27px; height: 25px; display: inline-block;"></div>' +
